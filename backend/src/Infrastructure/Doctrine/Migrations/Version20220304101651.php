 ...
 */
final class Version20220304101651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subprocess ADD comes_from CHAR(36) DEFAULT NULL');
        $this->addSql('ALTER TABLE subprocess ADD CONSTRAINT FK_CD7FB059674B1641 FOREIGN KEY (comes_from) REFERENCES subprocess (uuid)');
        $this->addSql('CREATE INDEX IDX_CD7FB059674B1641 ON subprocess (comes_from)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_CD7FB059674B1641 ON subprocess');
        $this->addSql('ALTER TABLE subprocess DROP comes_from, CHANGE uuid uuid CHAR(36) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE process_uuid process_uuid CHAR(36) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
