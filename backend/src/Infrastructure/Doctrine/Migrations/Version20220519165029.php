 ...
 */
final class Version20220519165029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE process_package (process_uuid CHAR(36) NOT NULL, package_uuid CHAR(36) NOT NULL, priority INT NOT NULL, INDEX IDX_9610BD403E968293 (process_uuid), INDEX IDX_9610BD406A32356E (package_uuid), PRIMARY KEY(process_uuid, package_uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE project_processes (process_uuid CHAR(36) NOT NULL, project_uuid CHAR(36) NOT NULL, state VARCHAR(255) NOT NULL, priority INT NOT NULL, INDEX IDX_B514DB9B3E968293 (process_uuid), INDEX IDX_B514DB9BE8EE98BE (project_uuid), PRIMARY KEY(process_uuid, project_uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project_subprocesses (subprocess_uuid CHAR(36) NOT NULL, project_uuid CHAR(36) NOT NULL, state VARCHAR(255) NOT NULL, priority INT NOT NULL, INDEX IDX_1AE0D11685D245F3 (subprocess_uuid), INDEX IDX_1AE0D116E8EE98BE (project_uuid), PRIMARY KEY(subprocess_uuid, project_uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE subprocess (uuid CHAR(36) NOT NULL, process_uuid CHAR(36) DEFAULT NULL, comes_from CHAR(36) DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, priority INT NOT NULL, INDEX IDX_CD7FB0593E968293 (process_uuid), INDEX IDX_CD7FB059674B1641 (comes_from), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users (uuid CHAR(36) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, firstName VARCHAR(255) NOT NULL, lastName VARCHAR(255) NOT NULL, registered_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
