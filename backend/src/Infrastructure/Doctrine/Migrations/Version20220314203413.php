 ...
 */
final class Version20220314203413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_processes (process_uuid CHAR(36) NOT NULL, state CHAR(36) DEFAULT NULL, INDEX IDX_B514DB9BA393D2FB (state), PRIMARY KEY(process_uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
