 ...
 */
final class Version20220519145056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project_processes ADD state VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE project_subprocesses DROP FOREIGN KEY FK_1AE0D116A393D2FB');
        $this->addSql('DROP INDEX IDX_1AE0D116A393D2FB ON project_subprocesses');
        $this->addSql('ALTER TABLE project_subprocesses CHANGE state state VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project_processes DROP state, CHANGE process_uuid process_uuid CHAR(36) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE project_uuid project_uuid CHAR(36) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE INDEX IDX_1AE0D116A393D2FB ON project_subprocesses (state)');
