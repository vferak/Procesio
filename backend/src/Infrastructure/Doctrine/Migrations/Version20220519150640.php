 ...
 */
final class Version20220519150640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project_subprocesses ADD priority INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project_subprocesses DROP priority, CHANGE subprocess_uuid subprocess_uuid CHAR(36) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE project_uuid project_uuid CHAR(36) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE state state VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
