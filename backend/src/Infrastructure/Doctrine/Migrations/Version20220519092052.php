 ...
 */
final class Version20220519092052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE registrated_at registered_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    }
