 ...
 */
final class Version20220417112942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX fk_8d940019abfe1c6f ON workspace');
        $this->addSql('CREATE INDEX IDX_8D940019ABFE1C6F ON workspace (user_uuid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX idx_8d940019abfe1c6f ON workspace');
        $this->addSql('CREATE INDEX FK_8D940019ABFE1C6F ON workspace (user_uuid)');
        $this->addSql('ALTER TABLE workspace ADD CONSTRAINT FK_8D940019ABFE1C6F FOREIGN KEY (user_uuid) REFERENCES users (uuid)');
    }
}
