 ...
 */
final class Version20220304101859 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX fk_cd7fb059674b1641 ON subprocess');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX FK_CD7FB059674B1641 ON subprocess (comes_from)');
        $this->addSql('ALTER TABLE subprocess ADD CONSTRAINT FK_CD7FB059674B1641 FOREIGN KEY (comes_from) REFERENCES subprocess (uuid)');
