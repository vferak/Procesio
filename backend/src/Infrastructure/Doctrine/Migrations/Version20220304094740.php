 ...
 */
final class Version20220304094740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE package DROP INDEX FK_DE686795674B1641, ADD UNIQUE INDEX UNIQ_DE686795674B1641 (comes_from)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE package DROP INDEX UNIQ_DE686795674B1641, ADD INDEX FK_DE686795674B1641 (comes_from)');
