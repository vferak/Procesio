 ...
 */
final class Version20220304101336 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE process ADD comes_from CHAR(36) DEFAULT NULL');
        $this->addSql('ALTER TABLE process ADD CONSTRAINT FK_861D1896674B1641 FOREIGN KEY (comes_from) REFERENCES process (uuid)');
        $this->addSql('CREATE INDEX IDX_861D1896674B1641 ON process (comes_from)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_861D1896674B1641 ON process');
        $this->addSql('ALTER TABLE process DROP comes_from, CHANGE uuid uuid CHAR(36) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
