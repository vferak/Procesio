 ...
 */
final class Version20220304101521 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX fk_861d1896674b1641 ON process');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX FK_861D1896674B1641 ON process (comes_from)');
        $this->addSql('ALTER TABLE process ADD CONSTRAINT FK_861D1896674B1641 FOREIGN KEY (comes_from) REFERENCES process (uuid)');
