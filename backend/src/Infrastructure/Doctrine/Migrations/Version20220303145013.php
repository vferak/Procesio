 ...
 */
final class Version20220303145013 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX fk_de686795959d2364 ON package');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX FK_DE686795959D2364 ON package (workspace_uuid)');
        $this->addSql('ALTER TABLE package ADD CONSTRAINT FK_DE686795959D2364 FOREIGN KEY (workspace_uuid) REFERENCES workspace (uuid)');
